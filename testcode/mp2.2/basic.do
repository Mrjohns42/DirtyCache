echo "--- Executing initialization force file for ../testcode/mp2.2/basic.asm ---"
...
echo "Done initializing processor, loading ../testcode/mp2.2/basic.asm program code."
run 5
change /mp2_cpu/dram/pdram/vhdl_memory/mem(0) X"0D"
...
change /mp2_cpu/dram/pdram/vhdl_memory/mem(26) X"07"
change /mp2_cpu/dram/pdram/vhdl_memory/mem(27) X"00"
run 5
echo "Done loading ../testcode/mp2.2/basic.asm program code."
