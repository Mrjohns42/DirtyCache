echo "--- Executing initialization force file for ../testcode/mp2.2/dirty.asm ---"
...
echo "Done initializing processor, loading ../testcode/mp2.2/dirty.asm program code."
run 5
change /mp2_cpu/dram/pdram/vhdl_memory/mem(0) X"0D"
change /mp2_cpu/dram/pdram/vhdl_memory/mem(1) X"62"
change /mp2_cpu/dram/pdram/vhdl_memory/mem(2) X"0E"
change /mp2_cpu/dram/pdram/vhdl_memory/mem(3) X"64"
change /mp2_cpu/dram/pdram/vhdl_memory/mem(4) X"0F"
...
change /mp2_cpu/dram/pdram/vhdl_memory/mem(8) X"21"
...
change /mp2_cpu/dram/pdram/vhdl_memory/mem(21) X"62"
...
change /mp2_cpu/dram/pdram/vhdl_memory/mem(28) X"A0"
change /mp2_cpu/dram/pdram/vhdl_memory/mem(29) X"00"
change /mp2_cpu/dram/pdram/vhdl_memory/mem(30) X"20"
...
run 5
echo "Done loading ../testcode/mp2.2/dirty.asm program code."
