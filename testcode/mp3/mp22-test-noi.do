echo "--- Executing initialization force file for ../testcode/mp3/mp22-test-noi.asm ---"

echo "Resetting processor for 5 ns."
force /reset_l 0 @0
force /reset_l 1 @5

echo "Done initializing processor, loading ../testcode/mp3/mp22-test-noi.asm program code."
run 5
...
change /mp3_cpu/DRAM/vhdl_memory/mem(15) X"6A"
change /mp3_cpu/DRAM/vhdl_memory/mem(16) X"46"
change /mp3_cpu/DRAM/vhdl_memory/mem(17) X"1D"
change /mp3_cpu/DRAM/vhdl_memory/mem(18) X"12"
change /mp3_cpu/DRAM/vhdl_memory/mem(19) X"7C"
...
run 5
echo "Done loading ../testcode/mp3/mp22-test-noi.asm program code."
