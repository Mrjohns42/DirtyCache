...
RandLoop:
	...
	lea R7, SpotCheck;
	ldr R0, R7, SpotCheck[0]$BASEREL;
	ldr R0, R0, 0
	ldr R1, R7, SpotCheck[1]$BASEREL;
	LDR R1, R1, 0
	ldr R2, R7, SpotCheck[2]$BASEREL;
	LDR R2, R2, 0 
	ldr R3, R7, SpotCheck[3]$BASEREL;
	LDR R3, R3, 0
	ldr R4, R7, SpotCheck[4]$BASEREL;
	LDR R4, R4, 0
	ldr R5, R7, SpotCheck[5]$BASEREL;
	LDR R5, R5, 0
	ldr R6, R7, SpotCheck[6]$BASEREL;
	LDR R6, R6, 0
	ldr R7, R7, SpotCheck[7]$BASEREL;
	LDR R7, R7, 0
Halt:
	brnzp Halt;
