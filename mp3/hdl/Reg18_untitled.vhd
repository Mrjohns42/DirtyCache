--
-- VHDL ARCHITECTURE ECE411.REG18.UNTITLED
--
-- CREATED:
...
-- HDS INTERFACE_END
ARCHITECTURE UNTITLED OF REG18 IS
BEGIN
	REG18: PROCESS(CLK,RESET_L,A,EN)
	VARIABLE STATE : STD_LOGIC_VECTOR (17 DOWNTO 0);
	BEGIN
		IF(RESET_L = '0') THEN
			STATE := "000000000000000000";  -- DEFAULT VALUE
