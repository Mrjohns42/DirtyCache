echo "--- Executing initialization force file for ../testcode/mp3/factorialimm.asm ---"

echo "Resetting processor for 5 ns."
force /reset_l 0 @0
force /reset_l 1 @5

echo "Done initializing processor, loading ../testcode/mp3/factorialimm.asm program code."
run 5
change /mp3_cpu/DRAM/vhdl_memory/mem(0) X"25"
change /mp3_cpu/DRAM/vhdl_memory/mem(1) X"12"
change /mp3_cpu/DRAM/vhdl_memory/mem(2) X"21"
change /mp3_cpu/DRAM/vhdl_memory/mem(3) X"1C"
change /mp3_cpu/DRAM/vhdl_memory/mem(4) X"3F"
change /mp3_cpu/DRAM/vhdl_memory/mem(5) X"1E"
...
run 5
echo "Done loading ../testcode/mp3/factorialimm.asm program code."
